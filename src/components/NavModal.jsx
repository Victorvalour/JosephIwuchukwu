...
<motion.button 
        animate={"open"}
        onClick= {() => onClose()}
        className="flex flex-col self-end space-y-1.5 mr-3 bg-[#25A80F] w-fit h-fit py-2 rounded-lg px-2 md:hidden"
        >
        ...
        <div className='w-[80%] flex flex-col'>
                ...
                <div className='flex items-center h-10 mb-5 border-b-[1px] border-[#25A80F]'>
                    <p className=''>Home</p>
                </div>
